export const ADVICES = [
    {
        id: 2,
        title: 'How to contact an ambulance',
        image: '',
        description: `An emergency can strike you anywhere, anytime. It is very important to know how to contact 
                an ambulance using a mobile phone.`,
...

    {
        ...
        image: '',
        description: `Bleeding is the flow of blood from blood vessels into or out of
                organs, tissues, natural cavities of the body. Here you will learn what 
                first aid should be provided to avoid serious health consequences, 
                including death.`,
        content: `It has roots in a piece of classical Latin literature from 45 BC, making
...

    {
        ...
        image: '',
        description: `Without electricity, we can no longer imagine our lives. But it is 
                important to remember that without observing the rules for using electrical 
                appliances, an electric shock is possible, first aid is necessary, moreover, 
                without harm to others. Why is electricity dangerous and how does it affect 
                the body?`,
        content: `If you are going to use a passage of Lorem Ipsum, you need to be sure there
